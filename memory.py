...
summary_memory = ConversationSummaryMemory(llm=HuggingFaceEndpoint(repo_id="tiiuae/falcon-7b-instruct"), input_key="input")
...
llm = HuggingFaceEndpoint(repo_id="tiiuae/falcon-7b-instruct", temperature=0.9)
